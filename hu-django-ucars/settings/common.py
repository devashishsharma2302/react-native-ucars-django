...
"""
Django settings for hu-django-ucars project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'w9o^rthg(4=d-gn@w=0d9urhx(!6l@l0n^4)vun@p&_=v1(*as')
...
INSTALLED_APPS = [
    ...
    'hu-django-ucars.authentication',
...
ROOT_URLCONF = 'hu-django-ucars.urls'
...
WSGI_APPLICATION = 'hu-django-ucars.wsgi.application'
...
# See .ebextensions/hu-django-ucars.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'hu-django-ucars.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
